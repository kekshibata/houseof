...
type userskShibataprojectshouseofsrccomponentsseoJsx63159454QueryVariables = Exact<{ [key: string]: never; }>;


type userskShibataprojectshouseofsrccomponentsseoJsx63159454Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author'>> }> };
